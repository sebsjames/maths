...
int main()
{
    ...
    if constexpr (sm::has_size_method<sm::vec<float>>::value == true) {
    ...
    if constexpr (sm::has_size_method<std::deque<int>>::value == true) {
    ...
    if constexpr (sm::has_size_method<std::string>::value == true) {
