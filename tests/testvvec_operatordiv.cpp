...
int main()
{
    ...
    if (result1 != sj::vvec<float>{100, 200, 300}) { std::cout << "01bad\n"; --rtn; }
    ...
    if (result4 != sj::vvec<float>{100, 20, 3}) { std::cout << "04bad\n"; --rtn; }
    ...
    if (result6 != sj::vvec<sj::vec<float, 2>>{{100,100}, {200,200}, {300,300}}) { std::cout << "06bad\n"; --rtn; }
    ...
    if (result13 != sj::vvec<sj::vec<float, 2>>{{100,100}, {20,20}, {3,3}}) { std::cout << "13bad\n"; --rtn; }
    ...
    if (result15 != sj::vvec<sj::vec<float, 3>>{{100,100,100}, {20,20,20}, {3,3,3}}) { std::cout << "15bad\n"; --rtn; }
    ...
    if (result16 != sj::vvec<sj::vvec<float>>{{100,100}, {200,200}, {300,300}}) { std::cout << "16bad\n"; --rtn; }

    auto result17 = v_vvec3 / s;
    std::cout << "17: " << v_vvec3 << " / " << s << " = " << result17 << std::endl;
    if (result17 != sj::vvec<sj::vvec<float>>{{100,100,100}, {200,200,200}, {300,300,300}}) { std::cout << "17bad\n"; --rtn; }
    ...
    if (result23 != sj::vvec<sj::vvec<float>>{{100,100}, {20,20}, {3,3}}) { std::cout << "23bad\n"; --rtn; }
    ...
    if (result25 != sj::vvec<sj::vvec<float>>{{100,100,100}, {20,20,20}, {3,3,3}}) { std::cout << "25bad\n"; --rtn; }
