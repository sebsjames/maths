...
int main()
{
    ...
    morph::rand_normal<double, std::mt19937_64> rnorm (5, 1);
    ...
    while (n < 100) {
        ...
        morph::rand_normal<double, std::mt19937_64> rnorm_sigdiff (5.5, 1);
        ...
        morph::rand_normal<double, std::mt19937_64> rnorm_nonsigdiff (5.0, 1.5);
