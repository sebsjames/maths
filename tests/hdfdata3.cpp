...
int main()
{
    ...
    std::vector<std::array<FLT, 2>> va = { std::array<FLT, 2>{ FLT{1}, FLT{1}   },
                                           std::array<FLT, 2>{ FLT{3}, FLT{2}   },
                                           std::array<FLT, 2>{ FLT{5}, FLT{9.7} },
                                           std::array<FLT, 2>{ FLT{7}, FLT{8.1} },
                                           std::array<FLT, 2>{ FLT{9}, FLT{0.3} } };
    {
    ...
    std::vector<std::array<FLT, 3>> va3 = { std::array<FLT, 3>{ FLT{1.0}, FLT{1.0}, FLT{1.0} },
                                            std::array<FLT, 3>{ FLT{3.0}, FLT{2.0}, FLT{2.0} },
                                            std::array<FLT, 3>{ FLT{5.0}, FLT{9.7}, FLT{2.0} },
                                            std::array<FLT, 3>{ FLT{7.0}, FLT{8.1}, FLT{2.0} },
                                            std::array<FLT, 3>{ FLT{9.0}, FLT{0.3}, FLT{0.3} } };
    {
        sm::hdfdata data("test3.h5", std::ios::out | std::ios::trunc);
