...
int main()
{
    ...
    morph::range<int> sf = morph::algo::significant_cols (f);
    ...
    f = 4.123f;
    std::cout << "\nTest " << tnum << ": " <<  f << std::endl;
    sf = morph::algo::significant_cols (f);
    std::cout << "sf: " << sf << std::endl;
    ...
    std::cout << "\nTest " << tnum << ": " <<  f << std::endl;
    int prec = morph::algo::significant_figs (f);
    ...
    sf = morph::algo::significant_cols (d);
    std::cout << "sf: " << sf << std::endl;
    ...
    constexpr morph::range<int> sfce = morph::algo::significant_cols (std::numeric_limits<double>::quiet_NaN());
