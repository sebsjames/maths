...
int main()
{
    ...
    [[maybe_unused]] sm::vec<int, 2> vec2i = { 10, 100 };
    [[maybe_unused]] sm::vec<double, 2> vec2d = { 10, 100 };
    ...
    if (result1 != sm::vvec<float>{1010, 2010, 3010}) { std::cout << "01bad\n"; --rtn; }
    ...
    if (result4 != sm::vvec<float>{1010, 2100, 4000}) { std::cout << "04bad\n"; --rtn; }
    ...
    if (result6 != sm::vvec<sm::vec<float, 2>>{{1010,1010}, {2010,2010}, {3010,3010}}) { std::cout << "06bad\n"; --rtn; }
    ...
    if (result8 != sm::vvec<sm::vec<float, 2>>{{1010,1100}, {2010,2100}, {3010,3100}}) { std::cout << "08bad\n"; --rtn; }
    ...
    if (result8i != sm::vvec<sm::vec<float, 2>>{{1010,1100}, {2010,2100}, {3010,3100}}) { std::cout << "08ibad\n"; --rtn; }
    auto result8d = v_vec2 + vec2d;
    std::cout << "08d: " << result8d << std::endl;
    if (result8d != sm::vvec<sm::vec<float, 2>>{{1010,1100}, {2010,2100}, {3010,3100}}) { std::cout << "08dbad\n"; --rtn; }
    ...
    if (result13 != sm::vvec<sm::vec<float, 2>>{{1010,1010}, {2100,2100}, {4000,4000}}) { std::cout << "13bad\n"; --rtn; }
    ...
    if (result15 != sm::vvec<sm::vec<float, 3>>{{1010,1010,1010}, {2100,2100,2100}, {4000,4000,4000}}) { std::cout << "15bad\n"; --rtn; }
    ...
    if (result16 != sm::vvec<sm::vvec<float>>{{1010,1010}, {2010,2010}, {3010,3010}}) { std::cout << "16bad\n"; --rtn; }

    auto result17 = v_vvec3 + s;
    std::cout << "17: " << v_vvec3 << " + " << s << " = " << result17 << std::endl;
    if (result17 != sm::vvec<sm::vvec<float>>{{1010,1010,1010}, {2010,2010,2010}, {3010,3010,3010}}) { std::cout << "17bad\n"; --rtn; }
    ...
    if (result22 != sm::vvec<sm::vvec<float>>{{1010,1100}, {2010,2100}, {3010,3100}}) { std::cout << "22bad\n"; --rtn; }
    ...
    if (result25 != sm::vvec<sm::vvec<float>>{{1010,1100,2000}, {2010,2100,3000}, {3010,3100,4000}}) { std::cout << "25bad\n"; --rtn; }
