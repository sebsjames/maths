...
int main()
{
    ...
    // vvec of scalars
    sj::vvec<float> v_scal = { 1000, 2000, 3000 };

    // vvec of vecs
    sj::vvec<sj::vec<float, 2>> v_vec2 = { { 1000, 1000 },    { 2000, 2000 },    {3000, 3000 } };
    sj::vvec<sj::vec<float, 3>> v_vec3 = { { 1000, 1000, 1000 }, { 2000, 2000, 2000 }, {3000, 3000, 3000 } };

    // vvec of vvecs
    sj::vvec<sj::vvec<float>> v_vvec2 =  { { 1000, 1000 },    { 2000, 2000 },    {3000, 3000 } };
    sj::vvec<sj::vvec<float>> v_vvec3 =  { { 1000, 1000, 1000 }, { 2000, 2000, 2000 }, {3000, 3000, 3000 } };

    // A scalar for adding
    float s = 10;
    // Vecs for adding
    [[maybe_unused]] sj::vec<float, 2> vec2 = { 10, 100 };
    [[maybe_unused]] sj::vec<int, 2> vec2i = { 10, 100 };
    [[maybe_unused]] sj::vec<double, 2> vec2d = { 10, 100 };
    [[maybe_unused]] sj::vec<float, 3> vec3 = { 10, 100, 1000 };
    sj::vvec<float> vvec_f2 = { 10, 100 };
    sj::vvec<float> vvec_f3 = { 10, 100, 1000 };
    ...
    if (result1 != sj::vvec<float>{1010, 2010, 3010}) { std::cout << "01bad\n"; --rtn; }
    ...
    if (result4 != sj::vvec<float>{1010, 2100, 4000}) { std::cout << "04bad\n"; --rtn; }
    ...
    if (result6 != sj::vvec<sj::vec<float, 2>>{{1010,1010}, {2010,2010}, {3010,3010}}) { std::cout << "06bad\n"; --rtn; }
    ...
    if (result8 != sj::vvec<sj::vec<float, 2>>{{1010,1100}, {2010,2100}, {3010,3100}}) { std::cout << "08bad\n"; --rtn; }
    ...
    if (result8i != sj::vvec<sj::vec<float, 2>>{{1010,1100}, {2010,2100}, {3010,3100}}) { std::cout << "08ibad\n"; --rtn; }
    auto result8d = v_vec2 + vec2d;
    std::cout << "08d: " << result8d << std::endl;
    if (result8d != sj::vvec<sj::vec<float, 2>>{{1010,1100}, {2010,2100}, {3010,3100}}) { std::cout << "08dbad\n"; --rtn; }
    ...
    if (result13 != sj::vvec<sj::vec<float, 2>>{{1010,1010}, {2100,2100}, {4000,4000}}) { std::cout << "13bad\n"; --rtn; }
    ...
    if (result15 != sj::vvec<sj::vec<float, 3>>{{1010,1010,1010}, {2100,2100,2100}, {4000,4000,4000}}) { std::cout << "15bad\n"; --rtn; }
    ...
    if (result16 != sj::vvec<sj::vvec<float>>{{1010,1010}, {2010,2010}, {3010,3010}}) { std::cout << "16bad\n"; --rtn; }

    auto result17 = v_vvec3 + s;
    std::cout << "17: " << v_vvec3 << " + " << s << " = " << result17 << std::endl;
    if (result17 != sj::vvec<sj::vvec<float>>{{1010,1010,1010}, {2010,2010,2010}, {3010,3010,3010}}) { std::cout << "17bad\n"; --rtn; }
    ...
    if (result22 != sj::vvec<sj::vvec<float>>{{1010,1100}, {2010,2100}, {3010,3100}}) { std::cout << "22bad\n"; --rtn; }
    ...
    if (result25 != sj::vvec<sj::vvec<float>>{{1010,1100,2000}, {2010,2100,3000}, {3010,3100,4000}}) { std::cout << "25bad\n"; --rtn; }
