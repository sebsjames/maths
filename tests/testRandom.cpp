...
int main()
{
    ...
    sj::rand_uniform<SMALL_T, std::mt19937> rui;
    ...
    sj::rand_uniform<float, std::mt19937> ruf;
    ...
    sj::rand_uniform<double, std::mt19937_64> rud;
    ...
    sj::rand_uniform<unsigned int, std::mt19937_64> rubnd (0, 3);
    // You can find the min and max:
    ...
    // Similar for float
    sj::rand_uniform<float, std::mt19937> rubndf (0.0f, 1000.0f, 1);
    // You can find the min and max:
    ...
    sj::rand_uniform<float, std::mt19937> rubndf2 (0.0f, 1000.0f, 1);
    ...
    sj::rand_uniform<float, std::mt19937> rubndf3 (0.0f, 1000.0f);
    ...
    sj::rand_uniform<float, std::mt19937> rubndf4 (0.0f, 1000.0f);
    ...
    sj::rand_normal<double, std::mt19937_64> rnorm (5, 0.1);
    ...
    sj::rand_lognormal<double, std::mt19937_64> rln (5, 0.1);
    ...
    sj::rand_poisson<int, std::mt19937> rpois (5);
