...
int main()
{
    ...
    sm::vvec<float> filtered (25, 0);
    sm::vvec<float> filtered_slow (25, 0);

    sm::vvec<float> expect_result = { 17, 21, 25, 23, 19,  32, 34, 32, 30, 31,  47, 50, 47, 41, 46,  52, 55, 42, 30, 43,  37, 42, 35, 23, 31  };
    expect_result /= 9.0f;
...
#if 1
    sm::vvec<float> filtered_7x7 (80, 0);
    sm::vvec<float> filtered_7x7_slow (80, 0);
