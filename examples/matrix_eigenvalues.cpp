...
int main()
{
    ...
    for (size_t i = 0; i < 3; ++i) {
        std::cout << "  λ" << i << " = " << sym_lambdas[i].real() << "\n";
    }
    ...
    std::cout << "  λ₀ = " << float_lambdas[0].real() << "\n";
    std::cout << "  λ₁ = " << float_lambdas[1].real() << "\n";
    ...
    for (size_t i = 0; i < 3; ++i) {
        std::cout << "  λ" << i << " = " << id_lambdas[i].real() << "\n";
    }
    ...
    for (size_t i = 0; i < 4; ++i) {
        std::cout << "  λ" << i << " = " << diag_lambdas[i].real();
    ...
    for (size_t i = 0; i < 4; ++i) {
        std::cout << "  Pair " << i << ": λ = " << mat44_pairs[i].eigenvalue.real();
